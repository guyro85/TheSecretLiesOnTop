...
function loadImages(callback) {
    ...
    const imageFiles = {
        ...
        'elf_m_idle_0': 'elf_m_idle_anim_f0.png',
        'elf_m_idle_1': 'elf_m_idle_anim_f1.png',
        'elf_m_idle_2': 'elf_m_idle_anim_f2.png',
        'elf_m_idle_3': 'elf_m_idle_anim_f3.png',
        'elf_m_run_0': 'elf_m_run_anim_f0.png',
        'elf_m_run_1': 'elf_m_run_anim_f1.png',
        'elf_m_run_2': 'elf_m_run_anim_f2.png',
        'elf_m_run_3': 'elf_m_run_anim_f3.png',
        'lizard_m_idle_0': 'lizard_m_idle_anim_f0.png',
        'lizard_m_idle_1': 'lizard_m_idle_anim_f1.png',
        'lizard_m_idle_2': 'lizard_m_idle_anim_f2.png',
        'lizard_m_idle_3': 'lizard_m_idle_anim_f3.png',
        'lizard_m_run_0': 'lizard_m_run_anim_f0.png',
        'lizard_m_run_1': 'lizard_m_run_anim_f1.png',
        'lizard_m_run_2': 'lizard_m_run_anim_f2.png',
        'lizard_m_run_3': 'lizard_m_run_anim_f3.png',
        'lizard_f_idle_0': 'lizard_f_idle_anim_f0.png',
        'lizard_f_idle_1': 'lizard_f_idle_anim_f1.png',
        'lizard_f_idle_2': 'lizard_f_idle_anim_f2.png',
        'lizard_f_idle_3': 'lizard_f_idle_anim_f3.png',
        'lizard_f_run_0': 'lizard_f_run_anim_f0.png',
        'lizard_f_run_1': 'lizard_f_run_anim_f1.png',
        'lizard_f_run_2': 'lizard_f_run_anim_f2.png',
        'lizard_f_run_3': 'lizard_f_run_anim_f3.png',
        'angel_idle_0': 'angel_idle_anim_f0.png',
        'angel_idle_1': 'angel_idle_anim_f1.png',
        'angel_idle_2': 'angel_idle_anim_f2.png',
        'angel_idle_3': 'angel_idle_anim_f3.png',
        'angel_run_0': 'angel_run_anim_f0.png',
        'angel_run_1': 'angel_run_anim_f1.png',
        'angel_run_2': 'angel_run_anim_f2.png',
        'angel_run_3': 'angel_run_anim_f3.png',
